...
!function (e) {
  ...
  var a,
      ...
      A = /iphone/i.test(e),
      i = /chrome/i.test(e),
      T = /android/i.test(e);S.mask = { definitions: { 9: "[0-9]", a: "[A-Za-z]", "*": "[A-Za-z0-9]" }, autoclear: !0, dataName: "rawMaskFn", placeholder: "_" }, S.fn.extend({ caret: function caret(e, t) {
      ...
      var n, b, k, y, x, j, R;if (!t && 0 < this.length) {
        var e = S(this[0]).data(S.mask.dataName);return e ? e() : void 0;
      }return v = S.extend({ autoclear: S.mask.autoclear, placeholder: S.mask.placeholder, completed: null }, v), n = S.mask.definitions, b = [], k = j = t.length, y = null, S.each(t.split(""), function (e, t) {
        ...
        function o() {
          ...
          var n, a;if (!(e < 0)) {
            for (n = e, a = l(t); n < j; n++) {
              if (b[n]) {
                if (!(a < j && b[n].test(m[a]))) break;m[n] = m[a], m[a] = c(a), a = l(a);
              }
          ...
          return "?" != e ? n[e] ? c(t) : e : void 0;
            ...
            d = m.join(""),
            p = g.val();g.data(S.mask.dataName, function () {
          ...
          var e;g.prop("readonly") || (clearTimeout(a), p = g.val(), e = h(), a = setTimeout(function () {
          ...
          if (!g.prop("readonly")) {
            var t,
                n,
                a,
                i = e.which || e.keyCode;R = g.val(), 8 === i || 46 === i || A && 127 === i ? (n = (t = g.caret()).begin, (a = t.end) - n == 0 && (n = 46 !== i ? function (e) {
          ...
          if (!g.prop("readonly")) {
            var t,
                ...
                a,
                i = e.which || e.keyCode,
                r = g.caret();e.ctrlKey || e.altKey || e.metaKey || i < 32 || !i || 13 === i || (r.end - r.begin != 0 && (f(r.begin, r.end), u(r.begin, r.end - 1)), (t = l(r.begin - 1)) < j && (n = String.fromCharCode(i), b[t].test(n)) && (function (e) {
              var t, n, a, i;for (n = c(t = e); t < j; t++) {
                if (b[t]) {
                  if (a = l(t), i = m[t], m[t] = n, !(a < j && b[a].test(i))) break;n = i;
                }
              }
          ...
          g.prop("readonly") || setTimeout(function () {
            var e = h(!0);g.caret(e), o();
          }, 0);
        }), i && T && g.off("input.mask").on("input.mask", function () {
          var e = g.val(),
              t = g.caret();if (R && R.length && R.length > e.length) {
            for (h(!0); 0 < t.begin && !b[t.begin - 1];) {
              t.begin--;
            }if (0 === t.begin) for (; t.begin < y && !b[t.begin];) {
              t.begin++;
            }g.caret(t.begin, t.begin);
          } else {
            for (h(!0); t.begin < j && !b[t.begin];) {
              t.begin++;
            }g.caret(t.begin, t.begin);
          }o();
        }), h();
